...
class _Paths(object):
    def __init__(self, root):
        ...
        # - C:\Users\Entity\AppData\Local\CCP\EVE\g_eve_tranquility\cache\MachoNet\87.237.34.200\409
    ...
    def __discover_mac(self, server_name):
        ...
        _localappdata = os.path.join(home,
                                     "Library/Application Support/EVE Online/p_drive/Local Settings/Application Data")
        if not os.path.exists(_localappdata):
            _localappdata = os.path.join(home,
                                         "Library/Preferences/EVE Online Preferences/p_drive/Local Settings/Application Data")
...
if __name__ == "__main__":
    paths = _Paths("G:/EVE")
    paths._discover("tranquility", "87.237.34.200", None)
